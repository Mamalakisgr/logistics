...
const fetchAndUpdateCompanyContent = async () => {
  try {
    ...
    if (response.ok) {
      ...
      document.getElementById('historyDescription').textContent = data.historyDescription;
      document.getElementById('valuesTitle').textContent = data.valuesTitle;
      document.getElementById('valuesDescription').textContent = data.valuesDescription;
      document.getElementById('visionTitle').textContent = data.visionTitle;
      document.getElementById('visionDescription').textContent = data.visionDescription;
    } else {
